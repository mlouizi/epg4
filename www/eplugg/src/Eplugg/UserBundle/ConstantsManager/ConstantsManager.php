<?php
namespace Eplugg\UserBundle\ConstantsManager;
class ConstantsManager {
    ...
    public static function mounthsArray() {
    ...
    public static function yearsArray() {
        return array('start' => '1905', 'end' => (date("Y") -1));
    }
    public static function civilityArray() {
        return array('1' => 'Mr', '2' => 'Mrs', '3' => 'Ms');
    }
}