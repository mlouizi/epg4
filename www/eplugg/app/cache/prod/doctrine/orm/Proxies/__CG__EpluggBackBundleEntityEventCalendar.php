 ...
 */
class EventCalendar extends \Eplugg\BackBundle\Entity\EventCalendar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'createdBy', 'created', 'eventDate', 'title');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventCalendar $proxy) {
    ...
    public function setCeatedBy(\Eplugg\UserBundle\Entity\User $ceatedBy)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCeatedBy', array($ceatedBy));

        return parent::setCeatedBy($ceatedBy);
    }
    ...
    public function getCeatedBy()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCeatedBy', array());

        return parent::getCeatedBy();
    }
