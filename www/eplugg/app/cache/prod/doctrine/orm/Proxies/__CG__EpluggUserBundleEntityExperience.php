 ...
 */
class Experience extends \Eplugg\UserBundle\Entity\Experience implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'etablissement', 'title', 'startDate', 'endDate', 'address', 'user');
        }
