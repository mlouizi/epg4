 ...
 */
class File extends \Eplugg\UserBundle\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'file', 'path');
        }

        return array('__isInitialized__', 'id', 'file');
    }
