...
<html xmlns="http://www.w3.org/1999/xhtml">
  	<head>
    	...
    	$(document).ready(function(){
      		$("#document_delete_image").click(function(){
          		$.ajax({
            		type: "POST",
					url:"/delete_image",
					data: {'delete': true},
					success:function(result) {
					  	...
					  	if (result.success) {
							...
							setTimeout('parent.document.location = "/user?id=<?= $profile['id_user'] ?>"', 1500) ;
    ...
    <body>     
    	<div class="jc-demo-box">
          	<div class="titre_plugg"><?= \Lang\delete_image ?></div>
           	<div class="clear10"></div>
            <div style="padding:10px">
              	<div id="message"></div>
              	<p><?= \Lang\msg_delete_image ?></p>
                <table width="80%" style="margin-left: 50px;">
                  	<tr>
                    	...
                    	<td colspan="2"><button type="submit" name="document_delete_image" id="document_delete_image" class="submit btn btn-large btn-inverse"><?= \Lang\delete ?></button></td>
                  	</tr>
                </table>
            </div>
        </div>
